document.addEventListener('DOMContentLoaded', () => {
    ...
    calcularBtn.addEventListener('click', () => {
        ...
        const soma1 = valor2 !== 0 ? valor1 / valor2 : "Divisão por zero";
        const soma2 = valor4 !== 0 ? valor3 / valor4 : "Divisão por zero";
        const soma3 = valor6 !== 0 ? Math.sqrt(valor5 * valor6) : "Divisão por zero";
