document.addEventListener('DOMContentLoaded', () => {
    ...
    calcularBtn.addEventListener('click', () => {
        ...
        const soma1 = valor2 !== 0 ? valor1 / valor2 : "NENHUM VALOR FOI DEFINIDO";
        const soma2 = valor4 !== 0 ? (valor3 ** 2) / valor4 : "NENHUM VALOR FOI DEFINIDO";
        const soma3 = valor6 !== 0 ? valor5 / (valor6 ** 2) : "NENHUM VALOR FOI DEFINIDO";
